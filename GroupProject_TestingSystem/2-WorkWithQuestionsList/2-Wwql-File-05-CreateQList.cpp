    ...
    if (QFile.is_open())
    {
        while (getline(QFile, line))
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                ...
                else if (i == 1) question.topic = decrypt(parsedLine[i]);
                else if (i == 2) question.question = decrypt(parsedLine[i]);
                else if (i == 3) question.answer_1 = decrypt(parsedLine[i]);
                else if (i == 4) question.answer_2 = decrypt(parsedLine[i]);
                else if (i == 5) question.answer_3 = decrypt(parsedLine[i]);
                else if (i == 6) question.answer_4 = decrypt(parsedLine[i]);
                else if (i == 7) question.rightAnswer = decrypt(parsedLine[i]);
